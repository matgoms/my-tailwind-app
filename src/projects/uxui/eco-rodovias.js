const Ecorodovias = { 
    ...
    contents: [

      {
        ...
        description: "The visual identity is a delightful fusion of pastel colors—blue, green, red, and yellow—that infuse a sense of warmth and joy into the project. These soft hues harmonize seamlessly, creating a visually appealing and inviting atmosphere. The choice of pastel colors goes beyond aesthetics; it conveys a sense of innocence, playfulness, and the genuine spirit of the holiday season.",
