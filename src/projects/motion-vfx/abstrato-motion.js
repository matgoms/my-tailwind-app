...
const Abstrato = { 
    ...
    description: 'Highlighted here are a collection of logo designs, along with their diverse variations, designed during my time at an advertising agency in São Paulo, Brazil. These designs were created specifically for auction companies and dealerships, showcasing my ability to distill brand identities into compelling visual symbols that resonate with audiences.',
    scope: 'Motion Design', 
    duration: '1 week',
