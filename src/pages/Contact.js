      ...
      <div className="bg-slate-50 dark:bg-slate-800 *:transition-colors duration-1000 ease-in-out">
        ...
        <section>
          <div className="py-24 px-6 max-w-screen-xl mx-auto lg:flex lg:gap-24 lg:mb-16">
            <div
              className="shrink transition ease-in duration-300 hover:opacity-80 lg:w-1/2 -my-8 bg-cover hidden lg:block" style={{backgroundImage: `url(../img/photos/42_1125x1500.jpg`}}
            />
