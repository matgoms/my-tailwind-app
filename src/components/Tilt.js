...
const TiltComponent = () => {
  return (
    ...
    >
      ...
      <div
        className="w-full h-full flex justify-center items-center duration-1000 ease-in-out *:absolute "
...
<dotlottie-player className="size-32" src="https://lottie.host/a478bc3b-87c6-4a54-a4ce-8ec2aeab6cda/vaMYRcJrKJ.json" background="transparent" speed="1" style={{transform: "translate3d(129px, 70px,200px)"}} direction="1" playMode="normal" loop autoplay></dotlottie-player>
        <img
        ...
        <img
          ...
          className="w-24 hidden dark:block dark:bg-slate-700 bg-slate-100 rounded-md "
          style={{ transform: "translate3d(-150px, 110px,200px)" }}
        />
        <img
          src="../img/home/toolsdark.png"
          className="w-24 block dark:hidden bg-slate-200 rounded-xl"
          style={{ transform: "translate3d(-150px, 110px,200px)" }}
        />
      </div>
    </Tilt> */
