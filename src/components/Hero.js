...
export function HeroBig() {
  return (
   <>
    <section>
    <div className="grid gap-16 max-w-screen-xl px-6 py-16 mx-auto lg:grid lg:grid-cols-2 lg:py-24 ">
        <div className="mr-auto place-self-center">
            <h1 className="max-w-2xl my-6 text-6xl font-extrabold tracking-tight leading-none xl:text-8xl dark:text-gray-100">Welcome to my portfolio!</h1>
          
            <p className="max-w-2xl mb-6 mt-8 font-body text-gray-500 lg:mb-8 text-xl lg:text-3xl dark:text-gray-400 text-balance">I'm a 27-years-old photographer, adventurer, art enthusiast and full-stack designer. Hope you enjoy my work.</p>
       ...
       {/*  <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
         ...
         <div className="lg:grid m-auto h-full hidden dark:mix-blend-screen dark:invert transition-all duration-200">
      <TiltComponent className=""/>
