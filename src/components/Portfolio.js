...
const selectedUXUI = uxuiContext.keys()[10];
      ...
      <section className="bg-slate-50 dark:bg-slate-900/50 transition-colors duration-1000 ease-in-out">
        <div className="px-6 py-24 mx-auto max-w-screen-xl sm:py-16 lg:gap-8 xl:gap-0 lg:py-48">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p className="text-gray-500 sm:text-xl dark:text-gray-400 text-balance">
          ...
          <div className="columns-1 lg:columns-3 lg:gap-24">
          <Link
            ...
            >
              <img
                ...
                className={`transition ease-in duration-300 hover:opacity-80  w-full mb-2 object-cover  aspect-[12/11] object-left ${uxuiProject.color}`}
              />
              <div className="mb-24 lg:mb-0 break-inside-avoid-column">
                <h3 className="my-6 text-xl font-bold dark:text-white">
                UX/UI Projects
                </h3>
            ...
            >
              <img
                ...
                className={`transition ease-in duration-300 hover:opacity-80 rounded-2xl w-full mb-2  aspect-[12/11]  object-cover object-center ${socialProject.color} outline-slate-300 dark:outline-slate-700 outline outline-1`}
              />
              <div className="mb-24 lg:mb-0 break-inside-avoid-column">
                <h3 className="my-6 text-xl font-bold dark:text-white">
                  Social Media
            ...
            >
              <img
                ...
                className={`transition ease-in duration-300 hover:opacity-80  w-full mb-2 aspect-[12/11]  object-cover object-center ${motionProject.color}`}
              />
              <div className="lg:mb-0 break-inside-avoid-column">
                <h3 className="my-6 text-xl font-bold dark:text-white">
            Motion/VFX Projects
                </h3>
                <p className="text-gray-500 dark:text-gray-400 text-pretty ">
