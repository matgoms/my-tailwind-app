...
const ImageFull = ({ image, altText, color }) => {
  ...
  <section className='w-full relative'>
        <div class="relative w-full h-[100vh] lg:h-dvh flex justify-center">
                <div alt={altText} id="HeroSection" className={`content-[""] w-full bg-fixed  h-full block h-[100vh] lg:h-dvh bg-cover bg-center bg-no-repeat -z-10 top-0 left-0 ${color}`}
