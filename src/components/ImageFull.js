...
const ImageFull = ({ image, altText, color }) => {
 ...
 <a class="absolute bottom-12 mx-auto lg:animate-bounce cursor-pointer bg-white/60 dark:bg-slate-800/60 p-2 w-14 h-14 rounded-full flex items-center justify-center backdrop-blur-sm transition-colors duration-1000 ease-in-out" href="#content">
