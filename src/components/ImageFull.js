...
const ImageFull = ({ image, altText, color }) => {
  ...
  <section className='w-full relative'>
        <div class="relative w-full h-[100vh] h-dvh flex justify-center">
                <div alt={altText} id="HeroSection" className={`content-[""] w-full bg-fixed  block h-dvh bg-cover bg-bottom bg-no-repeat -z-10 top-0 left-0 ${color}`}
