...
function Brands() {
  return (
    <>
      <section>
        <div className="py-16 mx-auto max-w-screen-2xl md:mt-48 sm:py-16 lg:px-6 lg:gap-8 xl:gap-0 lg:py-16 md:ring-2 ring-slate-50 ">
          <div className="lg:flex gap-10 max-w-screen-xl mx-auto px-6 items-center">
            ...
            <div className="gap-4 md:flex columns-2 md:columns-0 *:w-3/5 md:*:w-20 *:h-max hover:*:scale-105 hover:*:transition-all hover:*:ease-out hover:*:duration-50 *:object-contain space-y-8  md:gap-8 md:space-y-0">
